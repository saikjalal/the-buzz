...
describe("Tests of interface button functions", function () {
    ...
    it("UI/Logic Test: posting add creates new message", function () {
        ...
        var lastMessageRow = messageList.querySelector("table tr:last-child");
        var messageCell = lastMessageRow === null || lastMessageRow === void 0 ? void 0 : lastMessageRow.querySelector("td:first-child");
    ...
    it("UI Test: Add file to message", function () {
        ...
        var testFile = new File(["test file contents"], "test.txt", { type: "text/plain" });
        // Click on the send message button
        document.getElementById("sendMessageButton").click();
        // Verify that the message with the attached file was sent
        var sentMessage = document.querySelector(".message.sent");
